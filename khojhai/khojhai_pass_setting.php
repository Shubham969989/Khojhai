...
<title>Password Settings | KhojHai.com</title>
...
<a href='khojhai_setting.php' class='link_headr2' title='Settings'><u>Setting</u></a>
...
echo "<p class='err'>Password Cannot Be Less Than 6 Or More Than 35 Characters.
...
echo "<p class='err'>Your Old Password Was Invalid.
       <a href='#' class='err-close' onclick='errClose()'> X</a></p>";
...
echo "<p class='err'>Password Should Contain Only English Alphabets And/Or Digits, Without Any Space Or Special Characters.
       <a href='#' class='err-close' onclick='errClose()'> X</a></p>";
...
echo "<p class='err'>Password Changed Successfully !.
...
$qry_for_details = mysqli_query($con, "select id, name, gender from users where id = '$sess_id' LIMIT 1");

$qry_for_details_count = mysqli_num_rows($qry_for_details);

if($qry_for_details_count < 1)
{
header("Location: khojhai_home.php");
exit();
}

$qry_for_details_ftch = mysqli_fetch_array($qry_for_details);

$current_user_name = $qry_for_details_ftch['name'];

$current_user_gender = $qry_for_details_ftch['gender'];



echo '<form action= "khojhai_pass_setting2.php" method="POST" role="form" class="signup_form">';

echo '<span class="label">Current Password</span><br>';

echo '<input type = "text" id = "pass" name = "pass" class = "form-cntrl" required = "required" minlength = "6" maxlength = "35" placeholder = "Your Current Password" 

pattern = "[A-Za-z0-9]{6,35}$" 

required title = "Password Cannot Be Less Than 6 Or More Than 35 Characters, It Should Contain Only English Letters Or Digits Or Both, Without Any Spaces 

Or Special Characters" autocomplete = "off" autocorrect = "off" spellcheck = "false" /><br>';



echo '<span class="label">New Password</span><br>';

echo '<input type = "text" id = "pass2" name = "pass2" class = "form-cntrl" required = "required" minlength = "6" maxlength = "35" placeholder = "Enter New Password" 
...
echo '<input class = "btn" type = "submit" id = "submit" name = "submit" value = "Update" title = "Click Here To Update" /><br>';

echo '</form>';

?>

<div class='wrap_pass_setting_link'><a href='khojhai_setting.php' class='pass_setting_link'>Profile Settings</a></div>
