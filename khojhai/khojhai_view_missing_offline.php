...
{
header("Location: khojhai_view_missing.php?id={$_GET['id']}");
exit();
}
...
echo "<div class='details'>Added By<div class='sub-details'><a href='khojhai_login.php?err=6' class='added_by_link'>$case_added_by_name</a></div></div>";
...
echo "<a href='khojhai_login.php?err=6' class='bottom_links' title='Report This Case'>Report This Case</a><br>";
	
echo "<a href='khojhai_login.php?err=6' class='bottom_links' title='Save This Case'>Save This Case</a><br>";
