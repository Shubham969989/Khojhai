...
<title>Personal Settings | KhojHai.com</title>
...
echo "<p class='err'>Updated Successfully !.
...
echo '<form action= "khojhai_setting2.php" method="POST" role="form" class="signup_form">';

echo '<span class="label">Your Name</span><br>';

echo '<input type = "text" id = "name" name = "name" class = "form-cntrl" required = "required" minlength = "1" maxlength = "25" pattern = "[A-Za-z\s]{1,25}$" 

required title = "You Can Use Only English Characters and space. No Special Characters Are Allowed" spellcheck = "false" value = "'.$current_user_name.'" /><br>';


echo '<span class="label">Your Gender</span><br>';

if($current_user_gender == 'Male')
{	
echo '<select id="gender" name="gender" class="form-cntrl">';
...
<div class='wrap_pass_setting_link'><a href='khojhai_pass_setting.php' class='pass_setting_link'>Change Password</a></div>
