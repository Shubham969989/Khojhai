...
<a href='khojhai_search.php' class='link_headr' title='Search'><u>Search</u></a>
...
<form action= "khojhai_search2.php" method="GET" role="form" class="signup_form">
...
if($_GET['q'] == '0')
{
header("Location: khojhai_search.php?err=1");
exit();	
}

if(!($_GET['q']))
{
header("Location: khojhai_search.php?error");
exit();	
}	
...
{
header("Location: khojhai_search.php");
exit();	
}
?>
