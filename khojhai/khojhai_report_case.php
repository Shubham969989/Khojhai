...
<title>Report Against This Case | KhojHai.com</title>
...
echo "<p class='err'>Description Length Cannot Be Less Than 1 Character.<a href='#' class='err-close' onclick='errClose()'> X</a></p>";
...
echo "<p class='err'>Description Length Cannot Be More Than 300 Characters.
...
echo "<p class='err'>You Cannot Enter Only Single Numeric Zero(0) In Any Field.
<a href='#' class='err-close' onclick='errClose()'> X</a></p>";
...
$qry3 = mysqli_query($con, "select * from cases where id = '$get_id' and added_by_id != '$sess_id' ");
...
{
	header("Location: khojhai_home.php?error_error");
	exit();
}

echo '<form action= "khojhai_report_case2.php" method="POST" role="form" class="signup_form">';

echo '<span class="label">Please Select A Category*</span><br> 

      <select id="cat" name="cat" class="form-cntrl">

       <option value="Found">This Person Has Been Found</option>
	   
       <option value="Dead">This Person Is No Longer Alive</option>
...
echo '<span class="label">Give Us Some More Details*</span><br>

      <textarea id="desc" name="desc" rows="5" cols="50" class="form-cntrl-desc" placeholder="Describe Within 300 Characters.." required="required" 

       minlength="1" maxlength="300" spellcheck = "false" ></textarea><br>';

echo '<input type="hidden" id="case_id" name="case_id" value="'.$case_id.'" />';

echo '<input class = "btn" type = "submit" id = "submit" name = "submit" value = "Report" /><br>';
